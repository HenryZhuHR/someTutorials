...
public:
  ...
  //具体实现方法
  void printName() { printf("Jungle get Basketball\n"); }
...
public:
  ...
  //具体实现方法
  void printName() { printf("Jungle get Football\n"); }
...
public:
  ...
  //具体实现方法
  void printName() { printf("Jungle get Volleyball\n"); }
...
{
public:
  VolleyballFactory() { printf("VolleyballFactory\n"); }
